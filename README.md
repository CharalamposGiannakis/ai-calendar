...
The next engineering work is PDF table import on the existing review-first pipeline. Conflict checks and later AI-assisted features follow from that foundation.
